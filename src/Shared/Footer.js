...
const Footer = () => {
  return (
    <footer class="footer p-10 bg-base-200 text-base-content">
      <div>
        <span class="text-primary font-semibold text-lg">Services</span>
      ...
      <div>
        <span class="text-primary font-semibold text-lg uppercase">Links</span>
        <a href="#link" class="link link-hover font-semibold uppercase">
          Advertiser
        </a>
        <a href="#link" class="link link-hover font-semibold uppercase">
          Publisher
      ...
      <div>
        <span class="text-primary font-semibold text-lg">Documentation</span>
        <a href="#link" class="link link-hover font-semibold uppercase">
          Terms & Conditions
        </a>
        <a href="#link" class="link link-hover font-semibold uppercase">
      ...
      <div>
        <span class="text-primary font-semibold text-lg">Support</span>
